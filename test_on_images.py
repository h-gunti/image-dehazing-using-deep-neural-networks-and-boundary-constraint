...
#weight_path = "weights/nhhaze_generator_in512_ep160_loss297.h5" #weights for model training
weight_path = "weights/ohaze_generator_in512_ep120_loss125.h5" #weights for model training
#weight_path = "weights/densehaze_generator_in512_ep85_loss227.h5" #weights for model training
g.load_weights(weight_path)
g.summary()


output_dir = "compare_outputs" #output_folder
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

if __name__ == "__main__":

    img_src = glob.glob("compare_inputs/107.jpg") #path to image
    #img_src = glob.glob("C:\Users\Ramana\Desktop\deh\edn-gtm\path\data\A\01_hazy.png")
    ...
    for img_path in img_src:
        ...
        cv2.imwrite(f"{output_dir}/dehazed_{img_name}.jpg", rgb_de_test)
